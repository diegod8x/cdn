...
export declare class DataTableComponent implements OnInit, OnChanges {
    ...
    dtmDimentionsW(): void;
    validateRes(): number;
    determinateD(info: string): "right" | "left" | "center" | undefined;
    closeDte(): void;
    loadResp(): void;
    dtmRespTable(): void;
    ...
    getTransOrderProduct(): any[] | undefined;
    ...
    checkAtrTypeOperation(itemAttr: string): boolean | undefined;
    getInfoCardDownload(infoDownload: any): void;
    getInfoCardDownloadLink(infoDownloadLink: any): void;
    checkColumnAmountUs(info: any): boolean | undefined;
    activeWindowDateFunction(event: any): void;
    clickOutElementMount(event: any): void;
    getYearsArr(): any[] | undefined;
    getListTypeTransfer(): any[] | undefined;
    getListTypeAccountFrom(): any[] | undefined;
    getListTypeOperation(): any[] | undefined;
    toogleCheckIn(): void;
    getCommentsPrev(): any[] | undefined;
    convertFormatDate(infoDate: any): any[] | undefined;
    ...
    compDate(dte1: any, dte2: any, dtetm1: any, dtetm2: any): boolean | undefined;
    compDateBasic(dte1: any, dte2: any): boolean | undefined;
    orderByDate(): void;
    orderByAscDate(info: any): void;
    orderByDescDate(info: any): void;
    determinateItemColumnsAmounts(item: string): boolean | undefined;
    ...
    cleanAmount(amount: any): number | undefined;
    ...
    verifyColumnAmount(info: string): boolean | undefined;
    verifyColumnAmountTooltip(info: string): boolean | undefined;
    ...
    verifyDataExist(info: any, arrInfo: Array<any>): any[] | undefined;
    verifyDataExistSpecific(info: any, arrInfo: Array<any>): any[] | undefined;
    getDataActual(...infoData: any[]): any[] | undefined;
    getDataActualSpecific(...infoData: any[]): any[] | undefined;
    ...
    compareDteFrom(infoDteC: string, infoDteF: string): boolean | undefined;
    compareDteTo(infoDteC: string, infoDteF: string): boolean | undefined;
    compareDteDiffer(infoDteF: string, infoDteC: string): boolean | undefined;
    ...
    showArrow(columNumArrow: number): boolean | undefined;
    checkAtrPayment(itemAttr: string): boolean | undefined;
    checkColumnAlternative(columnPos: number): boolean | undefined;
    cleanFilters2(): void;
    cleanFilters(event: MouseEvent): void;
    determinateDate(infoDate: string): string | undefined;
}
